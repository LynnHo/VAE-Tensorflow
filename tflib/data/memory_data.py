...
def memory_data_batch_dataset(memory_data_dict, batch_size, prefetch_batch=_N_CPU + 1, drop_remainder=True, filter=None,
...
class MemoryData(Dataset):
    ...
    def __init__(self, memory_data_dict, batch_size, prefetch_batch=_N_CPU + 1, drop_remainder=True, filter=None,
...
if __name__ == '__main__':
    ...
    dataset = MemoryData(data, 2, filter=None, map_func=map_func,
                         shuffle=True, buffer_size=4096, drop_remainder=True, repeat=4, sess=s)
