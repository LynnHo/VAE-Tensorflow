...
class BytesTfrecordCreator(object):
    ...
    def __init__(self, save_path, infos, size_each=None, compression_type=0, overwrite_existence=False):
        # overwrite existence
...
class DataLablePairTfrecordCreator(BytesTfrecordCreator):
    ...
    def __init__(self, save_path, data_shape=None, data_dtype_or_format=None, data_name='data',
                 size_each=None, compression_type=0, overwrite_existence=False):
        super(DataLablePairTfrecordCreator, self).__init__(save_path, [], size_each, compression_type, overwrite_existence)
...
class ImageLablePairTfrecordCreator(DataLablePairTfrecordCreator):
    ...
    def __init__(self, save_path, encode_type='png', quality=95, data_name='img',
                 size_each=None, compression_type=0, overwrite_existence=False):
        super(ImageLablePairTfrecordCreator, self).__init__(
            save_path, None, None, data_name, size_each, compression_type, overwrite_existence)
